...
<root>
  ...
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── #ROOTNAMESPACE#.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── #ROOTNAMESPACE#.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── #ROOTNAMESPACE#.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `#ROOTNAMESPACE#`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package #DISPLAYNAME# Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/#ROOTNAMESPACE#.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/#ROOTNAMESPACE#.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/#ROOTNAMESPACE#.Editor.Tests.asmdef`

  `Tests/Runtime/#ROOTNAMESPACE#.Tests.asmdef`
...
Use the `Documentations~/#DISPLAYNAME#.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
